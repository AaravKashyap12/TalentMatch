...
class CandidateResult(BaseModel):
    ...
    semantic_overlap_score:  Optional[float] = None
    ...
    primary_backend_language: Optional[str]   = None
    jd_primary_backend_language: Optional[str] = None
    resume_role_family:      Optional[str]   = None
    jd_role_family:          Optional[str]   = None
    ...
    score_improvements:      List[str]       = Field(default_factory=list)
